 ...
 * @ignore
 */
export const REGEXP_PUNCTUATION = new RegExp(`[${asciiPunctuation}${latin1SupplementPunctuation}${generalPunctuationBlock}${supplementalPunctuationBlock}]`, "g");
/**
 ...
 * @ignore
 */
export const IS_PUNCTUATION = new RegExp(`^([${asciiPunctuation}${latin1SupplementPunctuation}${generalPunctuationBlock}${supplementalPunctuationBlock}])+$`);
/**
