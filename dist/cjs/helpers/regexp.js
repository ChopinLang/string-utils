 ...
 * @ignore
 */
exports.diacriticalMark = "\\u0300-\\u036F\\u1AB0-\\u1AFF\\u1DC0-\\u1DFF\\u20D0-\\u20FF\\uFE20-\\uFE2F";
/**
 ...
 * @ignore
 */
const latin1SupplementPunctuation = "\\u00A1-\\u00B1\\u00B4-\\u00B8\\u00BA\\u00BB\\u00BF\\u00D7\\u00F7";
/**
 ...
 * @ignore
 */
exports.REGEXP_PUNCTUATION = new RegExp(`[${asciiPunctuation}${latin1SupplementPunctuation}${generalPunctuationBlock}${supplementalPunctuationBlock}]`, "g");
/**
 ...
 * @ignore
 */
exports.IS_PUNCTUATION = new RegExp(`^([${asciiPunctuation}${latin1SupplementPunctuation}${generalPunctuationBlock}${supplementalPunctuationBlock}])+$`);
/**
 ...
 * @ignore
 */
exports.REGEXP_EXTENDED_ASCII = /^[\x01-\xFF\u0021-\u002F\u003A-\u0040\u005B-\u0060\u007B-\u007E\u00A1-\u00B1\u00B4-\u00B8\u00BA\u00BB\u00BF\u00D7\u00F7\u2000-\u206F\u2E00-\u2E7F]*$/;
/**
 ...
 * @ignore
 */
exports.REGEXP_LATIN_WORD = /([A-Z\xC0-\xD6\xD8-\xDE]?[a-z\xDF-\xF6\xF8-\xFF]+|[A-Z\xC0-\xD6\xD8-\xDE]+(?![a-z\xDF-\xF6\xF8-\xFF])|\d+)([\u0021-\u002F\u003A-\u0040\u005B-\u0060\u007B-\u007E\u00A1-\u00B1\u00B4-\u00B8\u00BA\u00BB\u00BF\u00D7\u00F7\u2000-\u206F\u2E00-\u2E7F]([a-z\xDF-\xF6\xF8-\xFF]*[A-Z\xC0-\xD6\xD8-\xDE]*\d*)*)*/g;
/**
 ...
 * @ignore
 */
exports.REGEXP_WORD = new RegExp("(?:[" +
    upperCaseLetter +
    "][" +
    exports.diacriticalMark +
    "]*)?(?:[" +
    lowerCaseLetter +
    "][" +
    exports.diacriticalMark +
